...
export default function NotFound() {
  return (
    <div className="rounded-[2rem] border border-mocha/10 bg-white p-10 text-center shadow-soft">
      ...
      <h1 className="mt-4 text-4xl font-semibold text-roast">This admin page does not exist.</h1>
      <p className="mt-4 text-base leading-7 text-mocha/80">The page may have been moved or the route is incorrect.</p>
